...
import { 
  Key, Mail, Loader2, AlertCircle, Eye, EyeOff, 
          ...
          <div className="glass-panel p-8 rounded-[2rem] border border-white/10 space-y-6 shadow-2xl relative">
            ...
            <div className="space-y-1.5 relative z-10">
              ...
              <p className="text-slate-500 text-xs">
                Log in to open your AI-powered reading study room
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              >
                {loading ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" /> Entering study room...
                  </>
                ) : (
                  'Sign In'
                )}
            ...
            <div className="pt-2 border-t border-white/5 space-y-3 relative z-10">
              <span className="block text-center text-xs text-slate-500">New to Bookophilic?</span>
              <Link 
                to="/register" 
